...
export default function ContactSettingsForm({ initial }: { initial: Settings }) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const rows = [
      ...
      { key: 'contact_email', value: contactEmail, updated_at: new Date().toISOString() },
    ]
      ...
      <section className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-3 py-2 border border-neutral-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-neutral-900"
            placeholder="contato@domuarquitetura.com.br"
          />
          <p className="text-xs text-neutral-400 mt-1">Usado para receber mensagens do formulário de contato do site.</p>
        </div>
      </section>
