  ...
  const SidebarContent = () => (
    <>
      <div className="px-6 py-5 border-b border-neutral-200 flex items-center justify-between">
        <span className="font-semibold text-neutral-900 text-sm tracking-wide">Domu Arquitetura</span>
        {/* Close button — mobile only */}
        <button
          className="md:hidden p-1 -mr-1 text-neutral-400 hover:text-neutral-700"
      ...
      <div className="px-3 py-4 border-t border-neutral-200">
        <button
          ...
          className="w-full text-left px-3 py-2 rounded-lg text-sm text-neutral-500 hover:bg-neutral-100 transition-colors"
        >
          Sair
        </button>
      </div>
  ...
  return (
    <>
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 z-40 h-14 bg-white border-b border-neutral-200 flex items-center px-4">
        ...
        <span className="ml-3 font-semibold text-neutral-900 text-sm tracking-wide">Domu Arquitetura</span>
      </div>
